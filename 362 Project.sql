...
CREATE VIEW Trail_Index AS SELECT trailID, trail_Name, city, difficulty FROM TRAILS;
...
-- This trigger will update the sch_score of the user as they mark a hike as completedd
-- CREATE TRIGGER sch_score_UPDATE AFTER UPDATE ON COMPLETED_TRAILS
-- FOR EACH ROW BEGIN
-- UPDATE USERS
-- SET trail_count = COUNT(*) FROM User_Completes
...
SELECT* FROM Trail_Index ORDER BY trailID;
